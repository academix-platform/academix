...
const DashboardShell = ({
  ...
  return (
    <div className="flex bg-academixPurpleLight h-screen overflow-hidden">
      ...
      <aside
        className={`academix-menu-scroll fixed inset-y-0 left-0 z-50 bg-academixPurpleLight p-4 w-64 overflow-auto transition-all duration-300 lg:static lg:translate-x-0 ${
      ...
      >
        ...
        >
          ...
          <button
            ...
            onClick={closeMenu}
            className="lg:hidden -top-1 right-0 absolute flex justify-center items-center hover:bg-academixPurple/35 rounded-md w-8 h-8 text-academixPurpleDark transition"
          >
            <X className="w-5 h-5" />
          </button>
        </div>
