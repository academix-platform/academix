...
CREATE TABLE "Exam" (
    ...
    "duration" INTEGER,
    "enableNavigation" BOOLEAN NOT NULL DEFAULT true,
    "enableAutoSave" BOOLEAN NOT NULL DEFAULT true,
    "autoSaveInterval" INTEGER NOT NULL DEFAULT 30,
    "enableAutoSubmit" BOOLEAN NOT NULL DEFAULT true,
...
-- AddForeignKey
ALTER TABLE "StudyMaterial" ADD CONSTRAINT "StudyMaterial_academicYearId_fkey" FOREIGN KEY ("academicYearId") REFERENCES "AcademicYear"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "Submission" ADD CONSTRAINT "Submission_academicYearId_fkey" FOREIGN KEY ("academicYearId") REFERENCES "AcademicYear"("id") ON DELETE SET NULL ON UPDATE CASCADE;
